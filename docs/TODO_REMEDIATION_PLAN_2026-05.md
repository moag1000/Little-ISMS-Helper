...
| ~~6.9~~ | ~~ESA Taxonomie RT_04 (Subcontractor-Chain) — dedizierte `DoraSubcontractor`-Entity + rekursiver Chain-Walker im Exporter~~ — **CLOSED 2026-05-26** (`feat/dora-rt04-subcontractor-chain-bucket-6-close`) |
