...
/**
 * Consistency guard for the EU-AI-ACT<->NIS2 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class AiActNis2PanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'eu-ai-act_to_nis2_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/eu-ai-act_to_nis2_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/eu-ai-act_to_nis2_completeness_candidates_v1.json';
