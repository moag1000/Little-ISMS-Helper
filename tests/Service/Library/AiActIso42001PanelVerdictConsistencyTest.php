...
/**
 * Consistency guard for the EU-AI-ACT<->ISO42001 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class AiActIso42001PanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'eu-ai-act_to_iso42001_v2.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/eu-ai-act_to_iso42001_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/eu-ai-act_to_iso42001_completeness_candidates_v1.json';
    private const SRC_KEY = 'eu';
