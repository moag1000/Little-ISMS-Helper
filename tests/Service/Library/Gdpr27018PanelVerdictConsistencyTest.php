...
/**
 * Consistency guard for the GDPR<->ISO27018 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class Gdpr27018PanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'gdpr_to_iso27018_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/gdpr_to_iso27018_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/gdpr_to_iso27018_completeness_candidates_v1.json';
    private const SRC_KEY = 'gdpr';
