...
/**
 * Consistency guard for the NIS2<->ISO27001 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class Nis2IsoPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'nis2-art21_to_iso27001-2022_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/nis2-art21_to_iso27001-2022_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/nis2-art21_to_iso27001-2022_completeness_candidates_v1.json';
