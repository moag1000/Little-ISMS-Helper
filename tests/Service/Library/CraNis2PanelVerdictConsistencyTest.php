...
/**
 * Consistency guard for the EU-CRA<->NIS2 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class CraNis2PanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'cra_to_nis2-art21_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/cra_to_nis2-art21_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/cra_to_nis2-art21_completeness_candidates_v1.json';
    private const SRC_KEY = 'cra';
