...
/**
 * Consistency guard for the DORA<->ISO27001 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class DoraRtsIsoPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'dora-rts-its_to_iso27001-2022_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/dora-rts-its_to_iso27001-2022_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/dora-rts-its_to_iso27001-2022_completeness_candidates_v1.json';
    private const SRC_KEY = 'dora';
