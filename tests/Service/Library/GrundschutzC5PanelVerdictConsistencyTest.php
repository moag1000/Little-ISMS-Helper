...
/**
 * Consistency guard for the BSI-GRUNDSCHUTZ<->BSI-C5 AI-expert-panel verdict fixtures.
 *
 ...
 */
final class GrundschutzC5PanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'bsi-it-grundschutz_to_bsi-c5-2020_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/bsi-it-grundschutz_to_bsi-c5-2020_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/bsi-it-grundschutz_to_bsi-c5-2020_completeness_candidates_v1.json';
    private const SRC_KEY = 'bsi';
    private const TGT_KEY = 'target';
