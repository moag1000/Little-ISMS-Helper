...
/**
 * Consistency guard for the NIS2-UmsuCG<->DORA AI-expert-panel verdict fixtures.
 *
 ...
 */
final class UmsucgDoraPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'nis2-umsucg_to_dora_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/nis2-umsucg_to_dora_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/nis2-umsucg_to_dora_completeness_candidates_v1.json';
