...
/**
 * Consistency guard for the KRITIS-DE<->NIS2-UmsuCG AI-expert-panel verdict fixtures.
 *
 ...
 */
final class KritisUmsucgPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'kritis-dachgesetz_to_nis2-umsucg_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/kritis-dachgesetz_to_nis2-umsucg_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/kritis-dachgesetz_to_nis2-umsucg_completeness_candidates_v1.json';
    private const SRC_KEY = 'kritis';
