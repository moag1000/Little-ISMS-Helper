 ...
 */
final class DoraIsoPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'dora_to_iso27001-2022_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/dora_to_iso27001-2022_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/dora_to_iso27001-2022_completeness_candidates_v1.json';
