...
/**
 * Consistency guard for the NIS2<->BSI_GRUNDSCHUTZ AI-expert-panel verdict fixtures.
 *
 ...
 */
final class Nis2GrundschutzPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'nis2-art21_to_bsi-it-grundschutz_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/nis2-art21_to_bsi-it-grundschutz_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/nis2-art21_to_bsi-it-grundschutz_completeness_candidates_v1.json';
    private const SRC_KEY = 'nis2';
