...
final class VdaIsaCrossFrameworkMappingTest extends TestCase
{
    ...
    /**
     * Smoke test: extraction script reproduces consistent output from ENX workbook.
    ...
    public function extractionScriptProducesConsistentOutput(): void {
        ...
        if (!file_exists($fix)) { self::markTestSkipped('ENX workbook fixture not present (tests/Fixtures/vda_isa_6_de_official.xlsx). Run: curl -sL https://portal.enx.com/isa6-de.xlsx -o tests/Fixtures/vda_isa_6_de_official.xlsx'); }
        self::assertFileExists($script,'Extraction script not found');
