...
/**
 * Consistency guard for the BSI-C5<->ENISA-EUCS AI-expert-panel verdict fixtures.
 *
 ...
 */
final class C5EucsPanelVerdictConsistencyTest extends TestCase
{
    private const FIX = __DIR__ . '/../../../fixtures/library/mappings/';
    private const YAML = self::FIX . 'bsi-c5-2020_to_eucs_v1.0.yaml';
    private const PANEL = self::FIX . 'panel_verdicts/bsi-c5-2020_to_eucs_panel_v1.json';
    private const COMPLETE = self::FIX . 'panel_verdicts/bsi-c5-2020_to_eucs_completeness_candidates_v1.json';
