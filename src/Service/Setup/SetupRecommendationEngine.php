 ...
 * wizard-session data.
 *
 * This class is intentionally free of infrastructure/request-bound dependencies
 * (Security, KernelInterface, EntityManagerInterface). The "apply starter baseline"
 * action that required those deps was extracted into {@see SetupBaselineApplier}.
 *
 * Public API:
