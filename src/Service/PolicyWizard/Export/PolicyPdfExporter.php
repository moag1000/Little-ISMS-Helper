...
class PolicyPdfExporter
{
    ...
    /**
     * @param array<string, mixed> $variables
     * @return array{batch_id: ?string, system_attribution: string, version: string}
     */
    ...
    private function renderBodyHtml(Document $doc): string
    {
        ...
        // The Document body is stored on disk for uploaded files; for
        // wizard-generated docs the canonical body lives in the
        // substitutionVariables (`_title` + `_body` after W3-J) or — for
        // legacy rows — in the description field. We try description
        // first, then substitutionVariables._body, then a stub.
