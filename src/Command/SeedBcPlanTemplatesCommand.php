...
class SeedBcPlanTemplatesCommand
{
    ...
    public function __invoke(
        ...
        foreach ($templates as $data) {
            ...
            $plan->setStatus(BusinessContinuityPlanStatus::Draft); // @phpstan-ignore lifecycle.directSetStatus (initial state on pre-persist entity; 'draft' is the business_continuity_plan_lifecycle initial_marking)
