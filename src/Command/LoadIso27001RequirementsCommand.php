...
class LoadIso27001RequirementsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success(sprintf('Successfully loaded %d ISO 27001:2022 Annex A requirements for cross-framework mapping', count($requirements)));
        $io->note('These are separate from Control entities - they enable cross-framework compliance mappings.');
