...
final class MappingQualityReportCommand extends Command
{
    ...
    private function amtlichSourceLabel(string $sourceCode, string $targetCode): string
    {
        return match (true) {
            ...
            ($sourceCode === 'BSI-C5' || $sourceCode === 'BSI_C5') && $targetCode === 'ISO27001' =>
                'BSI C5:2020 → ISO 27001:2022 official BSI cross-reference table',
            $sourceCode === 'DORA' && $targetCode === 'NIS2' =>
                'lex_specialis_candidate only (no verbatim EU table) — tier from panel verdicts',
            $sourceCode === 'NIST-CSF-2.0' || $sourceCode === 'NIST_CSF_2_0' =>
                'none (NIST publishes OLIR but no direct CSF↔ISO27001 official table) — panel-validated',
            $sourceCode === 'NIS2' =>
