 ...
 * against an official cross-reference table (CRT).
 *
 ...
 *
 * ## GDPR ↔ ISO 27701 pair (Annex D)
 *   php bin/console app:bsi:corroborate-mappings \
 *     --source-framework=ISO27701_2025 \
 *     --target-framework=GDPR \
...
#[AsCommand(
    ...
    description: 'WS-5b stage 1 — Elevate heuristic framework mappings corroborated by an official CRT to amtlich_gestuetzt (generalised: --source-framework / --target-framework / --official-provenance)'
)]
