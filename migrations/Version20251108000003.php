...
final class Version20251108000003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE supplier ADD CONSTRAINT FK_SUPPLIER_TENANT FOREIGN KEY (tenant_id) REFERENCES tenant (id)');
        ...
        $this->addSql('ALTER TABLE interested_party ADD CONSTRAINT FK_INTERESTED_PARTY_TENANT FOREIGN KEY (tenant_id) REFERENCES tenant (id)');
        ...
        $this->addSql('ALTER TABLE business_continuity_plan ADD CONSTRAINT FK_BC_PLAN_TENANT FOREIGN KEY (tenant_id) REFERENCES tenant (id)');
        ...
        $this->addSql('ALTER TABLE bc_exercise ADD CONSTRAINT FK_BC_EXERCISE_TENANT FOREIGN KEY (tenant_id) REFERENCES tenant (id)');
        ...
        $this->addSql('ALTER TABLE change_request ADD CONSTRAINT FK_CHANGE_REQUEST_TENANT FOREIGN KEY (tenant_id) REFERENCES tenant (id)');
    }

    public function down(Schema $schema): void
    {
        // Drop foreign keys, indices, then columns for supplier
        $this->addSql('ALTER TABLE supplier DROP FOREIGN KEY FK_SUPPLIER_TENANT');
        $this->addSql('DROP INDEX idx_supplier_tenant ON supplier');
        $this->addSql('ALTER TABLE supplier DROP tenant_id');

        // Drop foreign keys, indices, then columns for interested_party
        $this->addSql('ALTER TABLE interested_party DROP FOREIGN KEY FK_INTERESTED_PARTY_TENANT');
        ...
        // Drop foreign keys, indices, then columns for business_continuity_plan
        $this->addSql('ALTER TABLE business_continuity_plan DROP FOREIGN KEY FK_BC_PLAN_TENANT');
        ...
        // Drop foreign keys, indices, then columns for bc_exercise
        $this->addSql('ALTER TABLE bc_exercise DROP FOREIGN KEY FK_BC_EXERCISE_TENANT');
        $this->addSql('DROP INDEX idx_bc_exercise_tenant ON bc_exercise');
        $this->addSql('ALTER TABLE bc_exercise DROP tenant_id');

        // Drop foreign keys, indices, then columns for change_request
        $this->addSql('ALTER TABLE change_request DROP FOREIGN KEY FK_CHANGE_REQUEST_TENANT');
