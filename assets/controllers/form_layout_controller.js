...
export default class extends Controller {
    ...
    _markSectionDone(section, sectionId) {
        ...
        if (numEl) numEl.innerHTML = '<i class="fa-icon fa-icon--ui-check" aria-hidden="true"></i>';
        ...
        if (outlineItem) {
            ...
            if (stateEl) stateEl.innerHTML = '<i class="fa-icon fa-icon--ui-check" aria-hidden="true"></i>';
        }
    }
    ...
    _updateDraftStateText() {
        ...
        this.draftStateTarget.innerHTML = `<i class="fa-icon fa-icon--check-circle-fill" aria-hidden="true"></i> ${label}`;
    }
}
